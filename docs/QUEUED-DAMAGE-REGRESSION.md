...
Status: 0.3.3 test candidate, **runtime acceptance open** (issue #1).
...
| `8029DA` | Special destroy-after-hit caller ignores return; excluded from waiting |
...
- Ambiguous duplicate impacts, canceled queues, changed/destroyed projectiles,
  capacity overflow and expiry fail open. Special destroy-after-hit and
...
unverified. Four CTest groups cover policy, 144 synthetic actor-state layouts,
source wiring, and real dispatch/gate helpers with supplied health/death fixtures.
